...
Rating		Floating-point number			ating should be between 0.0 and 10.0 both inclusively, NULL is allowed.
...
Condition	A character that shows the condition
	        of the aircraft. One character.		NULL is not allowed.
...
TicketPrice	DECIMAL, up to 18 digits,
	        2 of which after the decimal point.	The DEFAULT value is 15, NULL is not allowed
1.	Database design
